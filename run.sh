...
python run.py --experiment_name one_shot_multi_dihedral --not_shuffle_clusters --n_cycles 3 --separate_modules_num 2 --node_features dihedral
...
python run.py --load_experiment one_shot_multi_dihedral --not_shuffle_clusters --n_cycles 3 --separate_modules_num 2 --node_features dihedral --test --load_epoch_mode best